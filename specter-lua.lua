...
task.spawn(function()
    ...
    watermark:Update { "rice.lua", ScriptProperties.UserPanel.Status, frames .. " FPS", string.format("%s:%s %s", tonumber(os.date("%I")), os.date("%M"), os.date("%p")) }
...
Discord = {
    ...
    DiscordCopyInv = Sections.Configuations.Discord:Button { Name = "Copy Invite", Callback = function()
        setclipboard("https://discord.gg/zrvbkv5v5Q")
    end }
